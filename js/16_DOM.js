...
document.querySelector("#btn1").addEventListener("click", () => {
    ...
    //  -> #test의 자식 노드 중 3번째 li 태그를 찾아서 배경색 pink 로
    ...
    // test.childNodes[9]의 다다음 형제 노드 선택
    // == test.childNodes[11]
    ...
    // -> list[11]의 마지막 자식으로 "ㅋㅋㅋ" 라는 TextNode 추가
    ...
    list[11].prepend("아", "휴 정말", "예스예");
    list[11].prepend("Hello"); // 첫번째 자식으로 추가
